...
const CardButtons = ({ id, imageUrl, name }: CardButtonsProps) => {
  ...
  const addToFavouritesHandler = (id: string, imageUrl: string, name: string) => {
    if (favQuantity < 1) {
      addToFavourites(id, imageUrl, name);
    } else {
